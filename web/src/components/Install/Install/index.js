  ...
  return (
    <center className={styles.command}>
      ...
      <CodeBlockString language={"sh"}>
        {"kubectl apply -f https://raw.githubusercontent.com/cyclops-ui/cyclops/v0.7.1/install/cyclops-install.yaml && \n" +
          "kubectl apply -f https://raw.githubusercontent.com/cyclops-ui/cyclops/v0.7.1/install/demo-templates.yaml"}
      </CodeBlockString>
    </center>
  );
};
