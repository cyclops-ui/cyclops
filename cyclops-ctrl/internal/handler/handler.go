...
func (h *Handler) Start() error {
	...
	h.router.GET("/modules/:namespace/:name/raw", modulesController.GetRawModuleManifest)
	h.router.POST("/modules/:namespace/:name/reconcile", modulesController.ReconcileModule)
